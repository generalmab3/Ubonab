...
زی‌پرشین `$17.186$` را به نویسهٔ اعشار فارسی تبدیل می‌کند که در قلم ریاضی قالب نیست و ممکن است به‌جای ممیز، کلمهٔ «و» دیده شود. نقطه را داخل آکولاد بگذارید:

```latex
$17{.}186 \pm 0{.}242$
```

درست: `$7{.}1$ درصد` — نادرست: `$7.1$ درصد`.
