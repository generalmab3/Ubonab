...
\begin{table}[H]
  ...
  \begin{tabular}{>{\centering\arraybackslash}p{0.28\textwidth} p{0.60\textwidth}}
    ...
    $s_{\min},\,s_{\max},\,s_{0}$ & کف و سقف مجاز و وضعیت شارژ آغازین \\
    $h,\,d$ & ساعت روز و نشانگر روز کاری در بردار ورودی \\
...
\begin{table}[H]
  ...
  \begin{tabular}{>{\centering\arraybackslash}p{0.28\textwidth} p{0.60\textwidth}}
    ...
    $\mathcal{U}(s)$ & مجموعه فرمان‌های مجاز در وضعیت شارژ فعلی \\
    $\mathcal{L}_{u}$ & خطای آموزش فرمان باتری \\
    $\mathrm{MSE}_{\mathrm{comp}}$ & میانگین مربع خطا روی چهار مؤلفه خروجی \\
    \bottomrule
  \end{tabular}
\end{table}
